...
export default function StarredCheckForm() {
  ...
  React.useEffect(() => {
    console.log('lol', process.env.NEXT_PUBLIC_FIREBASE_API_KEY)
}, [])
  ...
  <div className="flex flex-col items-center gap-8">
          <div>
            <button className="font-clash-semi rounded-[15px]" onClick={() => window.open("https://github.com/conductor-oss/conductor", "_blank")}>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 sm:p-8 w-full max-w-xs sm:max-w-md relative">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center">
              ...
              <label className="text-gray-700">
                Starred the <a href="https://github.com/conductor-oss/conductor" className="underline">conductor</a> repo
              </label>
            </div>
          </div>
        ...
        {result && (
          <p className="mt-6 text-center font-bold text-[#204289]">{result}</p>
        )}
      </div>
    </div>
      </div>
