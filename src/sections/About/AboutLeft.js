...
const AboutLeft = () => {
  return (
    <div className="flex justify-center py-12 my-8  p- md:p-12 text-left">
      ...
      <h1 className="hidden md:block absolute mt-5 w-auto left-[10%] right-[10%]  text-2xl top-[103px] font-bold mb-4 text-center border-b-4 border-dashed border-[#204289] pb-2"></h1>{" "}
    </div>
  );
};
