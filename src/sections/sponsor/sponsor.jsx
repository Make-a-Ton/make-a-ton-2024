    ...
    return (
        <Fragment>
            ...
            <div className="flex items-center justify-center w-full my-10">
                <div className="flex justify-center w-[30%] text-[#204289] font-satoshi-regular text-[30px]">
                    Silver Sponsors
                </div>

                <div className="flex justify-start flex-wrap w-[70%]">
                    {SilverImages.map((image, i) => (
                        <div key={i} className={`flex p-10 ${i % 2 == 0 ? 'bg-[#F6F5F5]' : ''}`}>
