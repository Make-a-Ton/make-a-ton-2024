            ...
            <div className="star-container bg-[#204289] min-h-screen p-2">
                ...
                <div className="flex flex-col text-white font-satoshi-regular items-center justify-center">
                   <Image src={"/assets/logo.svg"} alt={"logo"} width={200} height={200}/>
                    ...
                    <Link href="https://forms.eventsradar.in/makeaton/" className={"animate-shake mt-3 bg-white text-black font-satoshi-bold rounded-[15px] px-5 py-3 border-8 border-gray-500"}>
                        register</Link>
